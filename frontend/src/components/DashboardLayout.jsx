...
import { LayoutDashboard, Users, FileText, LogOut, Moon, Sun, Bell, X, RefreshCw, CalendarPlus, CalendarDays, Settings } from 'lucide-react';
...
const DashboardLayout = () => {
    ...
    const navItems = user?.role === 'admin' ? [
        ...
        { name: 'Leaves', path: '/leaves', icon: CalendarPlus },
    ];
